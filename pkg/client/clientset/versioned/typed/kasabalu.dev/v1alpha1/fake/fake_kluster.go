...
type FakeKlusters struct {
	Fake *FakeKasabaluV1alpha1
	ns   string
}

var klustersResource = schema.GroupVersionResource{Group: "kasabalu.dev", Version: "v1alpha1", Resource: "klusters"}

var klustersKind = schema.GroupVersionKind{Group: "kasabalu.dev", Version: "v1alpha1", Kind: "Kluster"}
