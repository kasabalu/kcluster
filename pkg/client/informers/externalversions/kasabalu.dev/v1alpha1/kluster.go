...
import (
	...
	kasabaludevv1alpha1 "github.com/kasabalu/kcluster/pkg/apis/kasabalu.dev/v1alpha1"
	versioned "github.com/kasabalu/kcluster/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kasabalu/kcluster/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kasabalu/kcluster/pkg/client/listers/kasabalu.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KasabaluV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KasabaluV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&kasabaludevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kasabaludevv1alpha1.Kluster{}, f.defaultInformer)
}
