...
import (
	...
	v1alpha1 "github.com/kasabalu/kcluster/pkg/client/informers/internalversion/v1alpha1"
...
type SharedInformerFactory interface {
	...
	Kasabalu() v1alpha1.Interface
}

func (f *sharedInformerFactory) Kasabalu() v1alpha1.Interface {
